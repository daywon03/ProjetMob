        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_profil) {
                    Intent intent = new Intent(EnSavoirPlusActivity.this, ProfilActivity.class);
                    startActivity(intent);
                }
                else if (id == R.id.nav_mon_habitat) {
                    Intent intent = new Intent(EnSavoirPlusActivity.this, MonHabitatActivity.class);
                    startActivity(intent);
                }
                else if (id == R.id.nav_habitats) {
                    Intent intent = new Intent(EnSavoirPlusActivity.this, HabitatActivity.class);
                    startActivity(intent);
                }
                else if (id == R.id.nav_reservation) {
                    Intent intent = new Intent(EnSavoirPlusActivity.this, ReservationActivity.class);
                    startActivity(intent);
                }
